...
<head>
    <meta charset="utf-8">
    <title>WebService | POSSW09</title>
...
<div id="container">
    ...
    <div id="body">
        ...
        <ol>
            <li><a href="<?php echo site_url('v1/products'); ?>">Listar produtos</a> - defaulting to JSON</li>
            <li><a href="<?php echo site_url('api/example/users/format/csv'); ?>">Users</a> - get it in CSV</li>
            <li><a href="<?php echo site_url('v1/products/1'); ?>">Produto #1</a> - defaulting to JSON  (users/1)</li>
            ...
            <li><a id="ajax" href="<?php echo site_url('v1/products/format/json'); ?>">Users</a> - get it in JSON (AJAX request)</li>
